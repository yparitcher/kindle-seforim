...
chelek=("Orach_Chayim" "Yoreh_De'ah" "Even_HaEzer" "Choshen_Mishpat")
...
convertsefer() {
	...
	fileout=$3
	ext=$4
	args=("$input" "$folderout$fileout.$ext" --subset-embedded-fonts --extra-css "$css" --chapter '//*[name()="h2" or name()="h3"]' --chapter-mark "none" --language "he" --base-font-size "16" --authors 'יוסף קארו' --toc-title "תוכן ענינים" --comments 'The Shulchan Aruch, via sefaria under the CC-BY-SA' --page-breaks-before '/')
