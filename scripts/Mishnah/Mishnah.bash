...
convertsefer() {
	...
	fileout=$3
	ext=$4
	args=("$input" "$folderout$fileout.$ext" --subset-embedded-fonts --extra-css "$css" --chapter '//*[name()="h2" or name()="h3"]' --chapter-mark "none" --language "he" --base-font-size "14" --authors 'משנה' --toc-title "תוכן ענינים" --comments 'The Mishnah, via sefaria under the CC-BY-SA' --sr1-replace '<br>' --page-breaks-before '/')
